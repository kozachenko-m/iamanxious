  ...
  return (
    <GlassCard className="p-3 pb-10 md:p-10">
      ...
      <div className="flex flex-col lg:flex-row gap-5 w-full px-4 mt-5">
        <HomeHowCard>
          <Image src="/worry-icon.svg" alt="" className="h-8 md:h-10 w-auto" width={40} height={40} />
          Share your worries
        </HomeHowCard>
        <HomeHowCard>
          <Image src="/chat-icon.svg" alt="" className="h-8 md:h-10 w-auto" width={40} height={40} />
          Read others&apos; worries
        </HomeHowCard>
        <HomeHowCard>
          <Image src="/happy-icon.svg" alt="" className="h-8 md:h-10 w-auto" width={40} height={40} />
          Feel better
        </HomeHowCard>
      </div>
    </GlassCard>
