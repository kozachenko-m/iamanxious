          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-screen-md mx-auto w-full">
            <GlassCard className="flex flex-col gap-5 p-5 w-full">
              <div className="w-full flex items-center justify-center">
                <Image src="/max.png" alt="" className="h-52 w-auto" width={200} height={208} />
              </div>
              <div>
            ...
            <GlassCard className="flex flex-col justify-between gap-5 p-5 pb-0">
              ...
              <div className="w-full flex items-center justify-end">
                <Image src="/alla.png" alt="" className="h-52 w-auto" width={200} height={208} />
              </div>
            </GlassCard>
          </div>
          <p>
            ...
            <br />
            <br />
            Whether you need Alla&apos;s design magic, Max&apos;s development expertise,
            or both, we are here to adapt to the specific requirements of your
            project. Please don&apos;t hesitate to contact us at{" "}
            <a
